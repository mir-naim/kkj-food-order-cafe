...
//Program Name: Product Actions 
//Descrption: Product Actions
//First written on: 14 October, 2023
//Edited on:
...
export const deleteReview = (id, productId) => async (dispatch) => {
  try {
    ...
    const { data } = await api.delete(`/api/v1/reviews?id=${id}&productId=${productId}`);
