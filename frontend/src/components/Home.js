...
//Program Name: Homepage
//Descrption: Homepage design and showing all food items
...
useEffect(() => {
  const hasSeenPopup = sessionStorage.getItem("promoShown");
      ...
      {showBanner && (
        ...
        >
          ...
          >
            ...
            <h2 style={{ marginTop: "15px" }}>🔥 Special Offer</h2>

            <p style={{ color: "#555" }}>
              Enjoy exclusive discounts on Cafe KKJ food items today!
            </p>
          </div>
        </div>
      )}
